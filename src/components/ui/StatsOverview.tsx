    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 sm:gap-6 px-3 sm:px-0">
        {statCards.map((card) => (
          ...
          >
            <div className="absolute top-0 right-0 w-16 sm:w-24 h-16 sm:h-24 bg-linear-to-br from-blue-500 to-purple-500 opacity-10 dark:opacity-20 rounded-bl-full"></div>
      ...
      {(stats.longestActivity || stats.highestElevation) && (
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          {stats.longestActivity && (
            <div className="bg-linear-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
                🏆 {t('statsOverview.longestActivity')}
              </h3>
          ...
          {stats.highestElevation && (
            <div className="bg-linear-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-xl shadow-lg p-6 border border-gray-100 dark:border-gray-700 hover:shadow-xl transition-shadow duration-300">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">
                ⛰️ {t('statsOverview.mostElevation')}
              </h3>
              <p className="text-gray-700 dark:text-gray-300 font-medium mb-2">
